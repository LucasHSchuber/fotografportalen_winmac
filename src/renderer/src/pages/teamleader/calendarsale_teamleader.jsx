...
import calendarimg1 from "../../assets/images/calendarimg1.jpg";
import calendarimg2 from "../../assets/images/calendarimg2.jpg";
import calendarimg3 from "../../assets/images/calendarimg3.jpg";
import calendarimg4 from "../../assets/images/calendarimg4.jpg";
import calendarimg5 from "../../assets/images/calendarimg5.jpg";
  ...
  return (
    <div className="teamleader-wrapper">
      <div className="calendarsale-teamleader-content">
        ...
        <div style={{ width: "70%" }}>
          <img
            className={`calendarsale-hero-img ${fade ? "fade-in" : "fade-out"}`}
            src={images[currentImageIndex]}
            alt="calendar sale"
          />
          <h5 className="my-3">
            <b>{languageTexts?.sportcalendar}</b>
          </h5>

          <p>{languageTexts?.salestextstart}</p>
          <p style={{ marginBottom: "0" }}>
            <b>{languageTexts?.salestextsheader}</b>
          </p>
          <p>
            <b>{languageTexts?.salestextcosts}</b>
          </p>
        ...
        <div className="mt-4">
          ...
          <button
            className="button standard fixed-width"
            onClick={yesCalendarSales}
          >
            {languageTexts?.yessalesButton}
          </button>
          <br />
          <br />
          <a
            style={{ textDecoration: "underline", cursor: "pointer" }}
            onClick={noCalendarSales}
          >
            {languageTexts?.nosalesLink}
          </a>
        </div>
      </div>
